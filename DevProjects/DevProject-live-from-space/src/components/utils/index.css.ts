...
const breakpoints = {
  ...
  "64em": "64em",
  // remove above lines
  largeMobileMax: "47.9375rem",
  tabletMin: "48rem", // 768px
  tabletMax: "61.9375rem",
}

export const media = {
  small: `screen and (min-width: ${breakpoints["40em"]})`,
  medium: `screen and (min-width: ${breakpoints["52em"]})`,
  large: `screen and (min-width: ${breakpoints["64em"]})`,
  // remove above lines
  tablet: `screen and (min-width: ${breakpoints.tabletMin}) and (max-width: ${breakpoints.tabletMax})`,
  largeMobile: `screen and (max-width: ${breakpoints.largeMobileMax})`,
}

export const bsMinMedia = {
  sm: `screen and (min-width: 36rem)`, // 576px
  md: `screen and (min-width: 48rem)`, // 768px
  lg: `screen and (min-width: 62rem)`, // 992px
  xl: `screen and (min-width: 75rem)`, // 1200px
  xxl: `screen and (min-width: 87.5rem)`, // 1400px
}
